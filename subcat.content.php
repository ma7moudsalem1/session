...
if($getsuppronum > 0){
			...
			<?php } ?>
                         ...
                         <?php
                         	if(isset($_POST['card'])){
                         		...
                         		$link = HOST_NAME.'sub-category/'.$url;
	...
	<?php
		...
		$q_subcat = "SELECT * FROM products WHERE cat = $catid";
						...
						<div class="col-md-12 col-sm-12">
							...
							<div class="margin-bottom-80">
								...
								<?php 
									...
									<li><i class="fa fa-flask"></i><a href="<?= HOST_NAME . 'product/'.$f_subcat['url'] ?>"><?= $f_subcat['title'] ?></a></li>
									<?php 
									}
								?>
								</ul>
