...
<div class="box box-info">
        <div class="box-header">
            <h3 class="box-title">
                <a href="index.php?p=subpro.add" class="btn text-green btn-success btn-app">
            ...
            <table class="table table-striped">
                <form method="post" action="">
                    ...
                    <tr>
                        ...
                        <th style="width: 35px">#</th>
                        <th>Title</th>
                        <th>View sub product</th>
                        
                    </tr>
                    
                    <?php
                        $id_page = $_GET['id'];
                        $qry = "SELECT * FROM subpro WHERE subcat =  $id_page ORDER BY id DESC";
                    ...
                    <tr>
                            ...
                            <td><a href="index.php?p=subpro.single&id=<?= $productData['id'] ?>"><?= $productData['id'] ?></a></td>
                            <td><a href="index.php?p=subpro.single&id=<?= $productData['id'] ?>"><?= $productData['name'] ?></a></td>
                            
                            
                           

                            <td>
                                <a href="index.php?p=subpro.single&id=<?= $productData['id'] ?>" class="btn btn-success btn-sm"><i class="fa fa-pencil-square"> View sub product</i></a>
                            </td>
                        ...
                        <?php
                            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                                if(isset($_POST['checked'])){
                                    ...
                                    $q_d = "DELETE FROM subpro WHERE id= $remove_id";
